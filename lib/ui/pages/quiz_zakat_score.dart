...
class QuizZakatScore extends StatefulWidget {
  @override
  _QuizZakatScoreState createState() => _QuizZakatScoreState();
}

class _QuizZakatScoreState extends State<QuizZakatScore> {
  _QuizZakatScoreState();
