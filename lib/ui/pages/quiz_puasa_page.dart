...
class QuizPuasaPage extends StatefulWidget {
  @override
  _QuizPuasaPageState createState() => _QuizPuasaPageState();
}

class _QuizPuasaPageState extends State<QuizPuasaPage> {
  bool isClickedSearch = false;

  final q1 = '''
  Q1 :
  Umat islam wajib berpuasa di bulan ?
  ''';
  final q2 = '''
  Q2 :
  ... membatalkan puasa 
...
class RadioGroupPuasa extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return new RadioGroupStatePuasa(qN);
  }
}

class RadioGroupStatePuasa extends State<RadioGroupPuasa> {
  List<MyChoice> choices = [];

  // TERDAPAT 2 PERTANYAAN MAKA KITA BUTUH 2 SET RADIO BUTTON
  RadioGroupStatePuasa(int qN) {
    if (qN == 0) {
      this.choices = [
        MyChoice(index: 0, choice: "Juli", verdict: false, questionN: 0),
        MyChoice(index: 1, choice: "Syawal", verdict: false, questionN: 0),
        MyChoice(index: 2, choice: "Ramadhan", verdict: true, questionN: 0),
        MyChoice(index: 3, choice: "Desember", verdict: false, questionN: 0),
      ];
    } else {
      this.choices = [
