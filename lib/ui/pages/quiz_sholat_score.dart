...
class QuizSholatScore extends StatefulWidget {
  @override
  _QuizSholatScoreState createState() => _QuizSholatScoreState();
}

class _QuizSholatScoreState extends State<QuizSholatScore> {
  _QuizSholatScoreState();
