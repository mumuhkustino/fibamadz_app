...
class QuizJenazahScore extends StatefulWidget {
  @override
  _QuizJenazahScoreState createState() => _QuizJenazahScoreState();
}

class _QuizJenazahScoreState extends State<QuizJenazahScore> {
  _QuizJenazahScoreState();
